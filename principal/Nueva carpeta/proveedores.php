...
$( document ).ready(function() {
    $.post( "accionp.php",{opcion:"agregar"}, function( data ) {
...
function eliminar(id){
	  $.post( "accionp.php",{opcion:"eliminar",id_persona:id}, function( data ) {
   $( "#proceso" ).html( data ).fadeIn().fadeOut(3000);
});
}
function modificar(id){
	  $.post( "accionp.php",{opcion:"modificar",id:id}, function( data ) {
   $( "#contenedor1" ).html( data );
});
}
</script>
