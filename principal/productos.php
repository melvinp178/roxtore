...
<div class="w3-main" style="margin-left:340px;margin-right:40px">
    ...
    <h1 class="w3-xxxlarge w3-text-red"><b>Seleccione una opcion</b></h1>
    <hr style="width:50px;border:5px solid red" class="w3-round">
      
         <li>
    
         <a href="g_prducto.php"  class="btn  btn-primary">agregar producto</a>
        </li>
         <br>
         <li>
         <a href="ver_productos.php"  class="btn btn-primary">Mis Productos</a>
        </li>
