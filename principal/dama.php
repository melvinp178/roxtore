...
<div class="w3-container" id="damas" style="margin-top:75px">
    <h1 class="w3-xxxlarge w3-text-red"><b> Dama.</b></h1>
    ...
    <div class="container">
          <div class="row" style="margin-left: 18vw;margin-right:18vw">
            ...
            $lista=$productoBD->seleccionarprod('damas');
            $n=0;
            while ($n < $num=$productoBD->contarprod('damas')) {
