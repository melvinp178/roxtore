<?php
  ...
  $lista=$productoBD->consultarproduser($id);
...
<div class="w3-main" style="margin-left:340px;margin-right:40px">
    ...
    <h1 class="w3-xxxlarge w3-text-red"><b>Mofificar Prodcutos</b></h1>
    <hr style="width:50px;border:5px solid red" class="w3-round">

        
        
        
        <form action="modificar_prod.php?var1=<?php echo $lista[0] ?>" method="post" enctype="multipart/form-data">
        <p>Nombre del Prducto</p> <input type="text" name="prod_nombre" placeholder="Nombre"  style="width:250px;height:33px" value="<?php echo $lista[1] ?>" required class="form-control span8 tip"/><br>
        <p>Precio del Prducto</p> <input type="number" step="any" style="width:250px;height:33px" name="prod_precio" value="<?php echo $lista[2] ?>" placeholder="Precio" required  class="form-control span8 tip"/><br> 
        <p>Categoria</p><select class="form-control" style="width:250px;" required name="categoria">
                  ...
                  <option value="damas" <?php echo $lista[3] == "damas" ? 'selected' : '' ?>>Damas</option>
                  <option value="caballeros" <?php echo $lista[3] == "caballeros" ? 'selected' : '' ?>>Caballeros</option>
                  <option value="niños" <?php echo $lista[3] == "niños" ? 'selected' : '' ?>>Niños</option>
              </select><br> 
        <input  class="btn btn-primary" type="submit" value="Aceptar">
        <a href="ver_productos.php" class="btn btn-primary">Cancelar</a>
        </form>
