...
<div class="w3-main" style="margin-left:340px;margin-right:40px">
  ...
  <div class="w3-container" id="caballeros" style="margin-top:75px">
    <h1 class="w3-xxxlarge w3-text-red"><b> Caballeros</b></h1>
    <hr style="width:50px;border:5px solid red" class="w3-round">
  </div>
    <div class="container">
          <div class="row" style="margin-left: 18vw;margin-right:18vw">
            <?php
            ...
            $lista=$productoBD->seleccionarprod('caballeros');
            $n=0;
            while ($n < $num=$productoBD->contarprod('caballeros')) {

              echo '<hr style="width:100%;border:4px solid blue" class="w3-round">
              <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                <img src="../images/'.$lista[$n]["prod_imagen"].'" style="width:100%">
              </div>
                <center>
                <h1 class="col-sm-12 col-md-12 col-lg-12 col-xl-12">'.$lista[$n]["prod_nombre"].'</h1>
                <button type="button" class="btn btn-primary btn-lg">
                  <span><b>$</b> '.$lista[$n]["prod_precio"].'</span>
                </button>
                </center>
                ';
              $n++;
